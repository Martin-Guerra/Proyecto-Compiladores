...
//###############################################################
    ...
    static void yycheck() {
        yycheck = new short[] {                        256,
                258,  258,   59,   59,  257,   44,  257,    0,   59,  267,
                267,    5,
        };
    }
    ...
    final static String yyname[] = {
            ...
            null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
            null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
            null,null,null,null,null,"ID","ULONGINT","IF","THEN","ELSE","END_IF","FOR",
            "OUT","PROC","RETURN","DOUBLE","MENOR_IGUAL","MAYOR_IGUAL","IGUAL","DISTINTO",
            "PUNTO_PUNTO","UP","DOWN","CADENA","NA","NRO_DOUBLE","NRO_ULONGINT",
    };
...
//########## USER-SUPPLIED ACTIONS ##########
                case 1:
//#line 27 "G08 - Gramatica - copia.y"
                {
                    syntacticTree = val_peek(0).tree;
                }
                break;
                case 2:
//#line 33 "G08 - Gramatica - copia.y"
                {
                    yyval.tree = val_peek(0).tree;
                }
                break;
                case 3:
//#line 37 "G08 - Gramatica - copia.y"
                {
                    yyval.tree = new SyntacticTree(val_peek(1).tree, val_peek(0).tree, "LISTA SENTENCIAS");
                }
                break;
                case 6:
//#line 47 "G08 - Gramatica - copia.y"
                {
                    addRule("Linea "+ la.getNroLinea() +": Sentencia declarativa - Variable/s.");
                    yyval = val_peek(0);
                    System.out.println("Size: " + yyval.attributes.size());
                    //for(int i = 0; i<3; i++){
                    //    System.out.println("Uso: " + yyval.attributes.get(i).getId());
                    //}
  							/*Attribute.setUse($2.attributes, Use.variable);
 							Attribute.setType($2.attributes, new Type($1.type.getName()));
 							for(Attribute a : $$.attributes){
 								System.out.println("Uso: " + a.getUse());
 								System.out.println("Uso: " + a.getType().getName());
 							}*/

                }
                break;
                case 7:
//#line 68 "G08 - Gramatica - copia.y"
                {
                    yyval.attributes = new ArrayList<>();

                    System.out.println("getNumberID" + la.getNumberId(val_peek(0).sval));
                    yyval.attributes.add(val_peek(0).attribute);
                    System.out.println("$1.attribute id" + val_peek(0).attribute);

                }
                break;
                case 8:
//#line 77 "G08 - Gramatica - copia.y"
                {
                    yyval = val_peek(2);
                ...
                break;
                case 9:
//#line 84 "G08 - Gramatica - copia.y"
                {
                    yyval.type = Type.ULONGINT;
                }
                break;
                case 10:
//#line 88 "G08 - Gramatica - copia.y"
                {
